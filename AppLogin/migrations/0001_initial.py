    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_teacher', models.BooleanField(default=False, help_text='Designates whether this user is a teacher', verbose_name='Teacher Status')),
                ('is_student', models.BooleanField(default=False, help_text='Designates whether this user is a student', verbose_name='Student Status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('profilepic', models.ImageField(blank=True, upload_to='teachers/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('profilepic', models.ImageField(blank=True, upload_to='students/')),
